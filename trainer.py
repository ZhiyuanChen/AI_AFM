...
def fit(
    args, train_loader, val_loader, model, loss_fn, optimizer, scheduler, n_epochs, cuda, log_interval, log, metrics=[]
):
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        elif ((epoch - 1) % log_interval == 0) or (
            epoch == n_epochs
        ):  # Save model at every log_interval AND very last epoch
